...
import com.bigdata.datacenter.datasync.service.impl.SubjectServiceImpl2Page
 ...
 */
class SubjectServiceJob implements Job{
    private static final Logger logger = Logger.getLogger(SubjectServiceJob.class)
    @Override
    public void execute(JobExecutionContext context) throws JobExecutionException {
        try {
            JobDataMap jobDataMap = context.getMergedJobDataMap();
            Map<String,Object> dds = (Map<String,Object>)jobDataMap.get("DS");
            SubjectServiceImpl2Page subjectService =  (SubjectServiceImpl2Page)jobDataMap.get("subjectServiceImpl2Page");
            ...
            if (group.equals(SubjectServiceImpl2Page.IMID)) {
                // 手动刷新
